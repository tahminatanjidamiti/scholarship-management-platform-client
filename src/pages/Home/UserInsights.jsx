    ...
    return (
        <div className='my-20'>
            <div className="text-center items-center">
                <h1 className="text-5xl font-bold">Grasp User <span className='text-transparent bg-clip-text bg-gradient-to-r from-black via-sky-500 to-teal-600'>Insights</span></h1>
            ...
            <div className='md:container mx-auto mt-5 space-y-5 bg-teal-100 px-5 py-10 rounded-lg'>
