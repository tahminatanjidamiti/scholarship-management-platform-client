...
const BestQualities = () => {
    ...
    return (
        <div className='my-20'>
            <div>
                <h1 className="text-4xl font-extrabold mb-8 flex justify-center items-center mx-auto">
                The Reason {' '}
                    <span style={{ color: '#0284c7', fontWeight: 'bold', paddingLeft: '10px' }}>
                        <Typewriter
                            words={['to Pick Us!']}
                            loop={Infinity}
                            cursor
            ...
            <p className='my-10 w-8/12 mx-auto text-center'>We develop transformative, high-quality educational experiences that inspire and empower students to achieve their fullest potential.</p>
            <div>
                <div className="card bg-white my-5 flex gap-5 w-11/12 mx-auto relative">
                <div className="absolute inset-0 bg-sky-200 animate-neon-glow -z-10"></div>
                <Marquee pauseOnHover={true} speed={100} className='space-x-10'>
                    ...
                    <div className="card-body items-center text-center">
                        ...
                        <div className="card-actions justify-end">
                            <p className='font-bold text-2xl text-black'>Regular Update</p>
                        </div>
                    </div>
                    <div className="card-body items-center text-center">
